...
export class Connection extends EventEmitter {
  ...
  protected _getNetworkTimeMs?: () => Promise<number>
  ...
  constructor (opts: NewConnectionOpts) {
    ...
    this._getNetworkTimeMs = opts.getNetworkTimeMs
  ...
  */
  ...
  protected async sendTestPacket (amount: Long, timeout = DEFAULT_PACKET_TIMEOUT): Promise<Packet | IlpPacket.IlpReject | null> {
    ...
    const prepare = {
      ...
      expiresAt: new Date(await this.getNetworkTimeMs() + timeout)
    }
  ...
  protected async getNetworkTimeMs () {
    return this._getNetworkTimeMs ? this._getNetworkTimeMs() : Promise.resolve(Date.now())
  }
  ...
  protected async sendConnectionClose (err?: ConnectionError | Error): Promise<void> {
    ...
    try {
      const prepare = {
        ...
        executionCondition: cryptoHelper.generateRandomCondition(),
        expiresAt: new Date(await this.getNetworkTimeMs() + DEFAULT_PACKET_TIMEOUT)
      }
